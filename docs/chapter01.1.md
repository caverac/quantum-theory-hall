...
$$
\sum_{n=0}^{\infty} e^{-An} = \frac{1}{1 - e^{-A}}.
$$

Taking the derivative with respect to $A$ on both sides gives

$$
\sum_{n=0}^{\infty} (-n) e^{-An} = -\frac{e^{-A}}{(1 - e^{-A})^2}.
$$
...
$$
\begin{align}
\langle E \rangle &= \frac{1}{Z}\sum_{n=0}^{\infty} (n\hbar \omega) e^{-\beta n \hbar \omega} \\
&= \hbar \omega \frac{1}{Z} \sum_{n=0}^{\infty} n e^{-\beta n \hbar \omega} \\
